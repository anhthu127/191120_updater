...
function createWindow() {
  ...
  ipcMain.on("authenticated", async event => {
    ...
    autoUpdater.setFeedURL(`https://191120-updater.vercel.app/update/${process.platform}/${app.getVersion()}`)
    ...
    autoUpdater.on('update-downloaded', (...args) => {
      const data = {
        ...
        'url': server,
        'repo': '191120',
        'token': '3863a338a9d035dc833aebb59e91ea32de369d4d'
      };

      win.webContents.send('log', 'update-downloaded', autoUpdater.getFeedURL({ data }), args)
